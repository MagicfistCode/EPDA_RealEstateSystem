    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                List<MyUser> allUsers = myUserFacade.findAll();
                ...
                out.println("<h3>Customer Users</h3>");
                ...
                for (MyUser userInfo : allUsers) {
                    if ("Customer".equals(userInfo.getUserrole())) {
                        out.println("<tr>");
                ...
                out.println("<div id=\"container\">");
                out.println("There are no existing customers!");
                out.println("</div>");
            }
        }
