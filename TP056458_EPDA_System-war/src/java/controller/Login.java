    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                if(found.getPassword() == null ? password != null : !found.getPassword().equals(password)){
                    throw new Exception();
                }
                ...
                if(null == userrole){
                    ...
                    out.println("<br><br>Hello " + found.getName());
                } else switch (userrole) {
                    case "Admin":
                        request.getRequestDispatcher("AdminHome.jsp").include(request, response);
                        out.println("<div id=\"container\">");
                        out.println("Hello " + found.getName() + " Welcome to Property APU!");
                        out.println("</div>");
                        break;
                    case "Owner":
