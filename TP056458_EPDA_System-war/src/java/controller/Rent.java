    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (property == null) {
                ...
                out.println("</div>");
            } else if (property.getRenterID() != null) {
                request.getRequestDispatcher("PropertyListings.jsp").include(request, response);
                out.println("<div id=\"container\">");
                out.println("Property with ID " + listingID + " not found.");
                out.println("</div>");
                ...
                try {
                    ...
                    double rentProperty = user.getBalance() - property.getPrice();
                    user.setBalance(rentProperty);
                    ...
                    property.setRentedBy(user.getName());
                    property.setRenterID(user.getId());
