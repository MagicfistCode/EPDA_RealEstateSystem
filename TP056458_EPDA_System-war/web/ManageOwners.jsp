<%-- 
    ...
    Created on : Aug 9, 2023, 11:16:09 PM
    Author     : dzaky
--%>
...
<div id="container">
    ...
    <form action="UpdateOwner" method="POST">
        ...
        Enter Owner Username: <input type="text" name="username" size="20">
    ...
    <form action="ViewOwners" method="POST">
        <h3>View All Owners</h3>
        <p><input type="submit" value="View Owners"></p>
    </form>
</div>
</body>
</html>
